...
class _NowPlayingPageState extends State<NowPlayingPage>
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(top: 32, left: 24, right: 24, bottom: 16), child: _progressBar(),)
            ],
          ),
        ),
      ),
  ...
  StreamBuilder<DurationState> _progressBar(){
     return StreamBuilder<DurationState>(stream: _audioPlayerManager.durationState, builder: (context, snapshot){
